...
mod tests {
    ...
    fn end_to_end_test() {
        ...
        end_to_end_test_template::<MNT6_298>().expect("test failed for MNT6");
    ...
    fn linear_polynomial_test() {
        ...
        linear_polynomial_test_template::<MNT6_298>().expect("test failed for MNT6");
    ...
    fn batch_check_test() {
        ...
        batch_check_test_template::<MNT6_298>().expect("test failed for MNT6");
